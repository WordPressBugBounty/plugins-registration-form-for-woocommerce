...
export default (props) => {
	...
	useClientId(props.clientId, setAttributes, props.attributes, 'select');

	useUpdateLabel(props, __('Select', 'registration-form-for-woocommerce'));
		...
		<>
			...
			>
				...
				<select
					...
					disabled
				>
					<option value={placeholder ? placeholder : options?.[0] || ''}>
